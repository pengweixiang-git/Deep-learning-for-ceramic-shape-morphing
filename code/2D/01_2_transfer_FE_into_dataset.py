...
while arrow <= 32745:
    ...
    while i <= 25:
        ...
        linenodestr2 = '*Nset, nset=_PickedSet2_#%d, internal' % (i + 25)
        lineelestr2 = '*Elset, elset=_PickedSet2_#%d, internal, generate' % (i + 25)
        ...
        materialline2 = '*Solid Section, elset=_PickedSet2_#%d, orientation=Ori-1' % (i + 25)
        ...
        material_array = [property1, property2]
        ...
        for nodenumb in result_list:
            ...
            if point[0] < Max_XY_Vaules[0] and point[1] < Max_XY_Vaules[1]:
    ...
    for xx in InOutputarray:
        # print(xx[0][0])
        allstr = '  '.join([str(xx[0][0]), str(xx[0][1]), str(str(xx[1][0])), str(str(xx[1][1])), str(str(xx[2][0])), str(str(xx[2][1])), str(str(xx[2][2]))])
